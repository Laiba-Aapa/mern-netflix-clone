...
const WatchPage = () => {
  ...
  useEffect(() => {
    const getTrailers = async () => {
      try {
        const response = await apiRequest.get(`/${contentType}/${id}/trailers`);
  ...
  useEffect(() => {
    const getSimilarContent = async () => {
      try {
        const response = await apiRequest.get(`/${contentType}/${id}/similar`);
  ...
  // get the details of movie or tv show
  useEffect(() => {
    const getContentDetail = async () => {
      try {
        const response = await apiRequest.get(`/${contentType}/${id}/details`);
  ...
  return (
    <div className="bg-black min-h-screen text-white">
      <div className="mx-auto container px-4 py-8 h-full ">
        ...
        <div className="flex justify-between flex-col md:flex-row items-center gap-20  max-w-6xl mx-auo">
