          ...
          <div className="max-w-2xl ">
            ...
            <div className="flex mt-8">
              <Link
                ...
                className="flex items-center bg-white hover:bg-white/80 text-black px-4 py-2 font-bold rounded mr-4"
              >
                <Play className="size-6 mr-2 fill-black" /> Play
              </Link>
              <Link
                to={`watch/${trendingContent?.id}`}
                className="flex items-center bg-gray-500/70 hover:bg-gray-500 text-white px-4 py-2  rounded mr-4"
              >
